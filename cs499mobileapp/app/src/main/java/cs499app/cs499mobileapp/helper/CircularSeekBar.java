...
public class CircularSeekBar extends View {
     ...
     * True if the pointer should lock at zero and max, false if it should not.
     */
     ...
     *  if user touch input is to be accepted, false if user touch input is to be ignored.
     */
